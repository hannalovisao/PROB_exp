...
$PYTHON_CMD -u main_open_world.py \
    --output_dir "${EXP_DIR}/t1" --dataset $DATASET --PREV_INTRODUCED_CLS 0 --CUR_INTRODUCED_CLS 4\
    --train_set 'zod_cropped_t1_train_clear' --test_set 'zod_cropped_test_clear' --epochs 41\
...
PY_ARGS=${@:1}
$PYTHON_CMD -u main_open_world.py \
    --output_dir "${EXP_DIR}/t2" --dataset $DATASET --PREV_INTRODUCED_CLS 4 --CUR_INTRODUCED_CLS 2\
    --train_set 'zod_cropped_t2_train_clear' --test_set 'zod_cropped_test_clear' --epochs 51\
...
PY_ARGS=${@:1}
$PYTHON_CMD -u main_open_world.py \
     --output_dir "${EXP_DIR}/t2_ft" --dataset $DATASET --PREV_INTRODUCED_CLS 4 --CUR_INTRODUCED_CLS 2 \
     --train_set "${WANDB_NAME}/learned_zod_t2_ft" --test_set 'zod_cropped_test_clear' --epochs 111 --lr_drop 40\
     --model_type 'prob' --obj_loss_coef 8e-4 --obj_temp 1.3\
...
PY_ARGS=${@:1}
$PYTHON_CMD -u main_open_world.py \
     --output_dir "${EXP_DIR}/t3" --dataset $DATASET --PREV_INTRODUCED_CLS 6 --CUR_INTRODUCED_CLS 4\
     --train_set 'zod_cropped_t3_train_clear' --test_set 'zod_cropped_test_clear' --epochs 121\
...
PY_ARGS=${@:1}
$PYTHON_CMD -u main_open_world.py \
     --output_dir "${EXP_DIR}/t3_ft" --dataset $DATASET --PREV_INTRODUCED_CLS 6 --CUR_INTRODUCED_CLS 4 \
     --train_set "${WANDB_NAME}/learned_zod_t3_ft" --test_set 'zod_cropped_test_clear' --epochs 181 --lr_drop 35\
     --model_type 'prob' --obj_loss_coef 8e-4 --obj_temp 1.3\
...
PY_ARGS=${@:1}
$PYTHON_CMD -u main_open_world.py \
    --output_dir "${EXP_DIR}/t4" --dataset $DATASET --PREV_INTRODUCED_CLS 10 --CUR_INTRODUCED_CLS 4\
    --train_set 'zod_cropped_t4_train_clear' --test_set 'zod_cropped_test_clear' --epochs 191 \
    --model_type 'prob' --obj_loss_coef 8e-4 --freeze_prob_model --obj_temp 1.3\
...
PY_ARGS=${@:1}
$PYTHON_CMD -u main_open_world.py \
    --output_dir "${EXP_DIR}/t4_ft" --dataset $DATASET --PREV_INTRODUCED_CLS 10 --CUR_INTRODUCED_CLS 4\
    --train_set "${WANDB_NAME}/learned_zod_t4_ft" --test_set 'zod_cropped_test_clear' --epochs 261 --lr_drop 50\
    --model_type 'prob' --obj_loss_coef 8e-4 --obj_temp 1.3\
